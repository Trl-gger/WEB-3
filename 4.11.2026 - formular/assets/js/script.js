...
let idMeno = document.getElementById("meno")
let idVek = document.getElementById("vek")
let idMesto = document.getElementById("mesto")
let idKonicek = document.getElementById("konicek")
let idRok_narodenia = document.getElementById("rok-narodenia")
let idDo_dospelosti = document.getElementById("do-dospelosti")
